...
Anonymous mode is enabled by default and the default dashboard is accessible with no login needed. Default administrator's credentials are admin:caretta.
