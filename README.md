...
* The built-in Victoria Metrics and Grafana instances can be disabled by specifing the values **victoria-metrics-single.enabled** or **grafana.enabled** accordingly.
